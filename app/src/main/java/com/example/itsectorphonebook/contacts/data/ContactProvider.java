...
public class ContactProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.contacts/contacts" will map to the
        ...
        // For example, "content://com.example.android.contacts/contacts/3" matches, but
        // "content://com.example.android.contacts/contacts" (without a number at the end) doesn't match.
    ...
    private Uri insertContact(Uri uri, ContentValues values) {
        ...
        Integer weight = values.getAsInteger(ContactEntry.COLUMN_CONTACT_PHONENUMBER);
    ...
    private int updateContact(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link contactEntry#COLUMN_CONTACT_GENDER} key is present,
        ...
        // If the {@link contactEntry#COLUMN_CONTACT_PHONENUMBER} key is present,
        // check that the phone value is valid.
        if (values.containsKey(ContactEntry.COLUMN_CONTACT_PHONENUMBER)) {
            // Check that the weight is greater than or equal to 0 kg
            Integer phone_number = values.getAsInteger(ContactEntry.COLUMN_CONTACT_PHONENUMBER);
